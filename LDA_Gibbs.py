...
class LdaSampler(object):
    ...
    def __init__(self, n_topics, alpha=0.1, beta=0.001):
        """
        n_topics: desired number of topics
        alpha: prior weight of topic k in a document;
               usually the same for all topics; 
               normally a number less than 1, e.g. 0.1, to prefer sparse topic distributions, 
               i.e. few topics per document
        beta: prior weight of word w in a topic; usually the same for all words;
